...
public class QuizService {
    ...
    public QuizService(QuizResultRepository quizResultRepository, QuizRepository quizRepository, QuizMapper quizMapper, QuizQuestionRepository quizQuestionRepository, QuizQuestionMapper quizQuestionMapper) {
    ...
    public ResponseEntity<?> getQuiz(String name){
